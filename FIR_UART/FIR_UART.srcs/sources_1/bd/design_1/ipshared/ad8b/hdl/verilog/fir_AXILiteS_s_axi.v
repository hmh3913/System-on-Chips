...
//------------------------Parameter----------------------
localparam
    ADDR_Y_DATA_0 = 11'h010,
    ADDR_Y_CTRL   = 11'h014,
    ADDR_X_DATA_0 = 11'h400,
    ADDR_X_CTRL   = 11'h404,
    ADDR_C_BASE   = 11'h200,
    ADDR_C_HIGH   = 11'h3ff,
    WRIDLE        = 2'd0,
...
assign int_c_address1 = ar_hs? raddr[8:3] : waddr[8:3];
assign int_c_ce1      = ar_hs | (int_c_write & WVALID);
assign int_c_we1      = int_c_write & WVALID;
assign int_c_be1      = WSTRB << (waddr[2:2] * 4);
assign int_c_d1       = {2{WDATA}};
// int_c_read
always @(posedge ACLK) begin
    if (ARESET)
        int_c_read <= 1'b0;
