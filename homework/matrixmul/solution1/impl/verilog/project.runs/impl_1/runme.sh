...
HD_PWD='C:/Xilinx/SoC/matrixmul/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrixmul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrixmul.tcl -notrace
