...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 y R 0x0 "Data signal of y" {{0 32 y R 0 "Bit 31 to 0 Data signal of y"}}} {0x14 y_ctrl R 0x0 "Control signal of y" {{0 1 y_ap_vld R 0 "Control signal y_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 x W 0x0 "Data signal of x" {{0 32 x W 0 "Bit 31 to 0 Data signal of x"}}}}
        memories "c {base_address 64 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 58 II x}
