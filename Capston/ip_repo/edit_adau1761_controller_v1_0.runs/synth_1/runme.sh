...
HD_PWD='C:/Xilinx/Capston/ip_repo/edit_adau1761_controller_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adau1761_controller_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adau1761_controller_v1_0.tcl
