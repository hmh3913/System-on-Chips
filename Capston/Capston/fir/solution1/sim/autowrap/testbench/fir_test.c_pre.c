# 1 "C:/Xilinx/Capston/fir/fir_test.c"
# 1 "C:/Xilinx/Capston/fir/fir_test.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Xilinx/Capston/fir/fir_test.c" 2
# 46 "C:/Xilinx/Capston/fir/fir_test.c"
...
# 47 "C:/Xilinx/Capston/fir/fir_test.c" 2
...
#pragma pack(pop)
# 48 "C:/Xilinx/Capston/fir/fir_test.c" 2
# 1 "C:/Xilinx/Capston/fir/fir.h" 1
# 50 "C:/Xilinx/Capston/fir/fir.h"
typedef int coef_t;
typedef int data_t;
typedef int acc_t;
...
# 49 "C:/Xilinx/Capston/fir/fir_test.c" 2
