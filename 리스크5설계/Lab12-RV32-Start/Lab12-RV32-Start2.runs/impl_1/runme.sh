...
HD_PWD='C:/Xilinx/SoC/Lab12-RV32-Start/Lab12-RV32-Start2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_SoC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32I_SoC.tcl -notrace
