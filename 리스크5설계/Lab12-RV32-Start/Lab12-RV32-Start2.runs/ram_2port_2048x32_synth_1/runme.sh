...
HD_PWD='C:/Xilinx/SoC/Lab12-RV32-Start/Lab12-RV32-Start2.runs/ram_2port_2048x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_2port_2048x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_2port_2048x32.tcl
