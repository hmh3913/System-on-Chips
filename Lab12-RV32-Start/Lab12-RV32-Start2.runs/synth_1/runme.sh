...
HD_PWD='C:/Xilinx/SoC/Lab12-RV32-Start/Lab12-RV32-Start2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_SoC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_SoC.tcl
