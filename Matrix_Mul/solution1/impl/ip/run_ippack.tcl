...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 lm W 0x0 "Data signal of lm" {{0 32 lm W 0 "Bit 31 to 0 Data signal of lm"}}} {0x18 ln W 0x0 "Data signal of ln" {{0 32 ln W 0 "Bit 31 to 0 Data signal of ln"}}} {0x20 lp W 0x0 "Data signal of lp" {{0 32 lp W 0 "Bit 31 to 0 Data signal of lp"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS input_A input_B AB"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
