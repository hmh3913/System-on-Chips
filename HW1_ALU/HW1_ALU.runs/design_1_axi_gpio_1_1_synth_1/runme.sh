...
HD_PWD='C:/Xilinx/SoC/HW1_ALU/HW1_ALU.runs/design_1_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_1_1.tcl
