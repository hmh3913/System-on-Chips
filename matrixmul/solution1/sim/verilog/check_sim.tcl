...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixmul.autotvin_lm.dat"
         "c.matrixmul.autotvin_ln.dat"
         "c.matrixmul.autotvin_lp.dat"
         "c.matrixmul.autotvin_A.dat"
         "c.matrixmul.autotvin_B.dat"
         "c.matrixmul.autotvin_AB.dat"
         "c.matrixmul.autotvout_AB.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixmul.autotvout_AB.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
