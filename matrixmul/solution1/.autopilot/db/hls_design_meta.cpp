...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("A_q0", 8, hls_in, 3, "ap_memory", "mem_dout", 1),
	Port_Property("B_address0", 10, hls_out, 4, "ap_memory", "mem_address", 1),
	Port_Property("B_ce0", 1, hls_out, 4, "ap_memory", "mem_ce", 1),
	Port_Property("B_q0", 8, hls_in, 4, "ap_memory", "mem_dout", 1),
