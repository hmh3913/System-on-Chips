...
matrixmul::matrixmul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_j_1_fu_256_p2);
    sensitive << ( j1_reg_140 );
    ...
    sc_trace(mVcdFile, j_1_fu_256_p2, "j_1_fu_256_p2");
    sc_trace(mVcdFile, j_1_reg_358, "j_1_reg_358");
    ...
    sc_trace(mVcdFile, i1_reg_107, "i1_reg_107");
    sc_trace(mVcdFile, j2_reg_118, "j2_reg_118");
    sc_trace(mVcdFile, i_reg_129, "i_reg_129");
    sc_trace(mVcdFile, j1_reg_140, "j1_reg_140");
...
void matrixmul::thread_ap_clk_no_reset_() {
    ...
    if ((!(esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AB_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read())) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()))) {
...
void matrixmul::thread_AB_1_data_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read())))) {
...
void matrixmul::thread_AB_1_vld_in() {
    if (((!(esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AB_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read())) && 
...
void matrixmul::thread_A_0_ack_in() {
    A_0_ack_in = A_0_state.read()[1];
}

void matrixmul::thread_A_0_ack_out() {
    if ((!(esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AB_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read())) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()))) {
...
void matrixmul::thread_A_0_data_out() {
...
void matrixmul::thread_A_TREADY() {
    A_TREADY = A_0_state.read()[1];
}

void matrixmul::thread_B_0_ack_in() {
    B_0_ack_in = B_0_state.read()[1];
}

void matrixmul::thread_B_0_ack_out() {
    if ((!(esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AB_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read())) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()))) {
...
void matrixmul::thread_B_0_data_out() {
...
void matrixmul::thread_B_TREADY() {
...
void matrixmul::thread_ap_block_state8() {
    ap_block_state8 = (esl_seteq<1,1,1>(ap_const_logic_0, A_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_0_vld_out.read()));
}
...
void matrixmul::thread_exitcond1_fu_251_p2() {
    exitcond1_fu_251_p2 = (!j1_reg_140.read().is_01() || !p_reg_315.read().is_01())? sc_lv<1>(): sc_lv<1>(j1_reg_140.read() == p_reg_315.read());
}

void matrixmul::thread_exitcond2_fu_228_p2() {
    exitcond2_fu_228_p2 = (!i_reg_129.read().is_01() || !n_reg_309.read().is_01())? sc_lv<1>(): sc_lv<1>(i_reg_129.read() == n_reg_309.read());
}

void matrixmul::thread_exitcond3_fu_203_p2() {
    exitcond3_fu_203_p2 = (!j2_reg_118.read().is_01() || !p_reg_315.read().is_01())? sc_lv<1>(): sc_lv<1>(j2_reg_118.read() == p_reg_315.read());
}

void matrixmul::thread_exitcond4_fu_180_p2() {
    exitcond4_fu_180_p2 = (!i1_reg_107.read().is_01() || !n_reg_309.read().is_01())? sc_lv<1>(): sc_lv<1>(i1_reg_107.read() == n_reg_309.read());
}
...
void matrixmul::thread_grp_fu_295_p00() {
    grp_fu_295_p00 = esl_zext<16,8>(B_0_data_out.read());
}
...
void matrixmul::thread_grp_fu_295_p10() {
    grp_fu_295_p10 = esl_zext<16,8>(A_0_data_out.read());
}

void matrixmul::thread_i_1_fu_185_p2() {
    i_1_fu_185_p2 = (!i1_reg_107.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i1_reg_107.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void matrixmul::thread_i_2_fu_233_p2() {
    i_2_fu_233_p2 = (!i_reg_129.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_reg_129.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void matrixmul::thread_j_1_fu_256_p2() {
    j_1_fu_256_p2 = (!j1_reg_140.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(j1_reg_140.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void matrixmul::thread_j_fu_208_p2() {
    j_fu_208_p2 = (!j2_reg_118.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(j2_reg_118.read()) + sc_biguint<32>(ap_const_lv32_1));
}
...
void matrixmul::thread_tmp_10_cast_fu_271_p1() {
    tmp_10_cast_fu_271_p1 = esl_sext<64,12>(tmp_s_fu_266_p2.read());
}

void matrixmul::thread_tmp_1_fu_191_p1() {
    tmp_1_fu_191_p1 = i1_reg_107.read().range(7-1, 0);
}
...
void matrixmul::thread_tmp_2_fu_239_p1() {
    tmp_2_fu_239_p1 = i_reg_129.read().range(7-1, 0);
}

void matrixmul::thread_tmp_3_fu_214_p1() {
    tmp_3_fu_214_p1 = j2_reg_118.read().range(12-1, 0);
}

void matrixmul::thread_tmp_4_fu_262_p1() {
    tmp_4_fu_262_p1 = j1_reg_140.read().range(12-1, 0);
}
...
void matrixmul::thread_tmp_9_cast_fu_223_p1() {
    tmp_9_cast_fu_223_p1 = esl_sext<64,12>(tmp_9_fu_218_p2.read());
}
