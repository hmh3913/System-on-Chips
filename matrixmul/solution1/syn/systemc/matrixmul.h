...
struct matrixmul : public sc_module {
    ...
    sc_signal< sc_lv<32> > i1_reg_107;
    sc_signal< sc_lv<32> > j2_reg_118;
    sc_signal< sc_lv<32> > i_reg_129;
    sc_signal< sc_lv<32> > j1_reg_140;
